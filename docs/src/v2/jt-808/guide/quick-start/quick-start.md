...
```groovy
implementation 'io.github.hylexus.jt:jt-808-server-spring-boot-starter-boot2:2.1.4-rc.2'
```
...
```groovy
implementation 'io.github.hylexus.jt:jt-808-server-spring-boot-starter:2.1.4-rc.2'
```
