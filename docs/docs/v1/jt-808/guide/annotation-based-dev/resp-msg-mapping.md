...
本节内容是 [基于注解的消息处理器](docs/v1/jt-808/guide/annotation-based-dev/msg-handler-register.md) 的后续内容。

所以本小节所说的 `基于注解的响应消息映射` 都是基于 [基于注解的消息处理器](docs/v1/jt-808/guide/annotation-based-dev/msg-handler-register.md) 而言的，像下面这种处理方式：
