package io.github.hylexus.jt.demos.common.model.dto.jt1078;
...
@NoArgsConstructor
public class WebSocketVideoStreamSubscriberDto {
    ...
    public static WebSocketVideoStreamSubscriberDto of(WebSocketSession session, UriTemplate uriTemplate) {
