...
//import io.github.hylexus.jt808.msg.RespMsgBodySupport;
//import io.github.hylexus.jt808.utils.ProtocolUtils;
...
//
//import static io.github.hylexus.jt808.codec.BcdUtils.string2Bcd;
//import static io.github.hylexus.jt808.config.Constant.PACKAGE_DELIMITER;
//import static io.github.hylexus.utils.Bytes.concatAll;
//import static io.github.hylexus.utils.IntBitOps.intTo2Bytes;
//
///**
// * @author hylexus
// * createdAt 2019/2/5
...
//            // 3. 终端手机号 bcd[6]
//            baos.write(string2Bcd(terminalId));
...
//    }
//
//    public byte[] encodeRespMsg(RespMsgBodySupport bodySupport, int flowId, String terminalPhone) throws IOException {
