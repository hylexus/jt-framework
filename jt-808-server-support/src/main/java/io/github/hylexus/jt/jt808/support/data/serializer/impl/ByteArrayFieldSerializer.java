 ...
 * @author hylexus
 */
public class ByteArrayFieldSerializer implements Jt808FieldSerializer<byte[]> {

    private static final Set<ResponseMsgConvertibleMetadata> SUPPORTED_RESPONSE_MSG_CONVERTIBLE_METADATA = Jdk8Adapter.setOf(
            ConvertibleMetadata.forJt808ResponseMsgDataType(byte[].class, MsgDataType.BYTES),
            ConvertibleMetadata.forJt808ResponseMsgDataType(Byte[].class, MsgDataType.BYTES)
    );
