...
// TODO 重构两个 SessionManager
@Slf4j
@BuiltinComponent
public class DefaultAttachmentJt808SessionManager implements AttachmentJt808SessionManager {
    ...
    @Override
    public synchronized AttachmentJt808SessionManager addListener(Jt808SessionEventListener listener) {
