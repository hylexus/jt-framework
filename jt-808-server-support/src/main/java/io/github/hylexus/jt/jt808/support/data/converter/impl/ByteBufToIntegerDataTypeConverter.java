...
public class ByteBufToIntegerDataTypeConverter implements Jt808MsgDataTypeConverter<Integer> {
    ...
    private static final Set<ConvertibleMetadata> CONVERTIBLE_METADATA_SET = Set.of(
            ConvertibleMetadata.forJt808MsgDataType(MsgDataType.DWORD, Integer.class),
            ConvertibleMetadata.forJt808MsgDataType(MsgDataType.DWORD, int.class),
            ConvertibleMetadata.forJt808MsgDataType(MsgDataType.WORD, Integer.class),
            ConvertibleMetadata.forJt808MsgDataType(MsgDataType.WORD, int.class),
            ConvertibleMetadata.forJt808MsgDataType(MsgDataType.BYTE, Integer.class),
            ConvertibleMetadata.forJt808MsgDataType(MsgDataType.BYTE, int.class)
    );
