...
public class Jt808NettyTcpAttachmentServer extends AbstractRunner {
    ...
    public Jt808NettyTcpAttachmentServer(String name, Jt808AttachmentServerNettyConfigure serverConfigure, JtServerNettyConfigure.ConfigurationProvider configurationProvider) {
        super(name);
        ...
        final ServerBootstrap serverBootstrap = this.serverConfigure
                ...
                .childHandler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel ch) {
                        Jt808NettyTcpAttachmentServer.this.serverConfigure.configureSocketChannel(configurationProvider, ch);
                    }
                });
