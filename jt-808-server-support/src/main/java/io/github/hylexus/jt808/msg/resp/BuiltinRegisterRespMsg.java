...
public class BuiltinRegisterRespMsg implements RespMsgBody {
    /**
    ...
    public BuiltinRegisterRespMsg(int replyFlowId, byte result, String authCode) {
    ...
    public byte[] toBytes() {
        return Bytes.concatAll(
                ...
                new byte[]{result},
                result != 0 ? null : authCode.getBytes(JtProtocolConstant.JT_808_STRING_ENCODING)
        );
    }
