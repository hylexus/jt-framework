...
@Slf4j
@BuiltinComponent
public class BuiltinAuthRequestMsgV2019HandlerForDebugging extends AbstractBuiltinRequestMsgHandler<BuiltinAuthRequestMsgV2019> {

    private final AuthCodeValidator authCodeValidator;

    public BuiltinAuthRequestMsgV2019HandlerForDebugging(AuthCodeValidator authCodeValidator) {
    ...
    @Override
    protected Optional<RespMsgBody> doProcess(RequestMsgMetadata metadata, BuiltinAuthRequestMsgV2019 body, Jt808Session session) {
