...
import io.github.hylexus.jt808.msg.req.BuiltinRegisterRequestMsgV2019;
...
public class BuiltinRegisterRequestMsgV2019HandlerForDebugging extends AbstractBuiltinRequestMsgHandler<BuiltinRegisterRequestMsgV2019> {
    ...
    @Override
    protected Optional<RespMsgBody> doProcess(RequestMsgMetadata metadata, BuiltinRegisterRequestMsgV2019 msg, Jt808Session session) {
