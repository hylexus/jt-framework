...
public class AnnotationSamplesHandler {
    ...
    @Jt808RequestMsgHandlerMapping(msgType = 0x0001, desc = "终端通用应答", versions = Jt808ProtocolVersion.AUTO_DETECTION)
    public void processClientCommonReplyMsg(BuiltinTerminalCommonReplyMsgBody body, RequestMsgHeader header) {
        log.info("replyFlowId={}, replyMsgId={}", body.getReplyFlowId(), body.getReplyMsgId());
