...
public class RawDataJt1078ChannelCollector
    ...
    @Override
    protected RawDataSubscriber createSubscribe(String uuid, FluxSink<RawDataJt1078Subscription> fluxSink) {
        return new RawDataSubscriber(uuid, "request.body()", fluxSink);
    }
}
