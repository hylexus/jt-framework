...
import io.github.hylexus.jt.dashboard.client.actuator.jt1078.model.converter.DemoConverter;
...
public class FlvStreamSubscriberDemoWebSocket implements WebSocketHandler {
    ...
    public static final Scheduler SCHEDULER = Schedulers.newBoundedElastic(10, 1024, "demo-ws");
    ...
    public Mono<Void> handle(@NonNull WebSocketSession session) {
        ...
        final WebSocketVideoStreamSubscriberDto params = DemoConverter.convert(session, this.uriTemplate);
