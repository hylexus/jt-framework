...
public class BuiltinJt1078ControllerConfiguration {
    @Bean
    public BuiltinJt1078SessionManagerController builtinJt1078SessionManagerController(Jt1078PublisherManager publisherManager, Jt1078SessionManager sessionManager) {
