      ...
      <div slot="header" class="clearfix">
        <el-form inline size="mini" @submit.native.prevent>
          <el-form-item label="终端ID">
            <el-input v-model="query.terminalId" placeholder="terminalId" @keyup.enter.native="reloadData"></el-input>
          </el-form-item>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-tag
                :type="scope.row.version === '2019' ? 'primary' : 'success'"
                disable-transitions>{{ scope.row.version }}
              </el-tag>
            </template>
          </el-table-column>
          <el-table-column
          ...
          <el-table-column
            ...
            width="100">
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="videoButtonClick(scope.row)">音视频</el-button>
...
export default {
  ...
  methods: {
    ...
    reloadData() {
      requestTerminalList({...this.query}).then(resp => {
