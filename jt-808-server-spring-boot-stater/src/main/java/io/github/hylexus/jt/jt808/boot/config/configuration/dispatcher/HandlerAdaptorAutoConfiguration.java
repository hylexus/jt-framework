...
import io.github.hylexus.jt.jt808.support.dispatcher.handler.adapter.Jt808RequestMsgHandlerHandlerAdapter;
...
public class HandlerAdaptorAutoConfiguration {
    ...
    public Jt808HandlerAdapter jt808ReqMsgHandlerHandlerAdapter() {
        return new Jt808RequestMsgHandlerHandlerAdapter();
    }
